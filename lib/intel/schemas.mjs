/* ═══════════════════════════════════════════════════════════════════
   TIP — Shared JSON schemas + sanitizers for threat-intel content.
   Source of truth for field shapes/ids when researching and writing
   js/autofeed*.js by hand in an interactive Claude session. Keep in
   sync with the client-side re-validation in js/data.js
   (_sanitizeAutoFetched*) — that's a separate trust boundary and
   intentionally duplicates these checks rather than trusting hand-
   written output blindly.
   ═══════════════════════════════════════════════════════════════════ */
